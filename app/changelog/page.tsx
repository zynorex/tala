...
export default function Changelog() {
  const changelog: ChangelogEntry[] = [
    ...
    },
    {
      ...
      category: 'security',
      icon: Shield,
      title: 'P1 Security Vulnerability Fixes',
      description: 'Resolved all 7 security vulnerability issues from the full-project audit. Hardens authentication, secrets management, CSRF protection, input sanitization, and rate limiting across the application.',
      changes: [
