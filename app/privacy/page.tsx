      ...
      <section className="relative pt-32 pb-20 px-4 border-b-8 border-black overflow-hidden bg-cream">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="flex flex-col gap-6">
            <Link href="/legal" className="inline-flex items-center gap-2 font-black mb-8 hover:-translate-x-2 transition-transform bg-black text-white px-5 py-3 border-4 border-black shadow-[4px_4px_0_0_#BAFFC9] hover:shadow-[8px_8px_0_0_#BAFFC9] uppercase text-sm tracking-widest max-w-fit">
              <ChevronLeft className="w-5 h-5" strokeWidth={3} /> Back to Legal Directory
            </Link>
            
            <span className="inline-block bg-heirlock-green text-black border-2 border-black px-3 py-1 font-black uppercase text-sm tracking-widest shadow-[4px_4px_0_0_#000] max-w-fit mb-4 rotate-1">
              LEGAL DIRECTIVE // 02
            </span>
