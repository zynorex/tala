    ...
    <footer className="bg-black border-t-8 border-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-4 py-20 md:py-32 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 border-b-8 border-white pb-10 md:pb-16 mb-16">
          <div>
            <h2 className="text-6xl md:text-8xl lg:text-[140px] font-black uppercase tracking-tighter leading-none mb-6 -ml-1 text-heirlock-yellow hover:text-white hover:drop-shadow-[8px_8px_0_#BAE1FF] transition-all duration-300 cursor-default" style={{ textShadow: '8px 8px 0px #FF6961' }}>T.A.L.A.</h2>
            <p className="text-lg md:text-2xl font-bold max-w-2xl bg-white text-black p-4 inline-block border-4 border-black shadow-[8px_8px_0_0_#BAFFC9] hover:shadow-[12px_12px_0_0_#FFB3BA] hover:-translate-y-1 transition-all duration-300 leading-snug">
