...
const securityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://unpkg.com *.lh3.googleusercontent.com *.googleapis.com *.wallet.coinbase.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: https: http: blob:",
      "media-src 'self' blob:",
      "connect-src 'self' https: wss: http://localhost:* ws://localhost:*",
      "frame-src 'self' https://verify.walletconnect.com *.coinbase.com",
      "base-uri 'self'",
      "form-action 'self'",
